...
; メモリに読み込み終わったのでharibote.sysの実行を行う

    MOV     [0x0ff0],CH     ; iplがどこまで読んだかのメモ
    JMP     0xc200          ; haribote.sysが読み込まれている、メモリアドレスにジャンプする
...
msg:
    ...
    RESB    0x7dfe-$        ; 0x7ⅾfeまでを0x00で埋める命令
