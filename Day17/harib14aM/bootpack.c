...
void HariMain(void)
{
    ...
    struct SHEET *sht_back, *sht_mouse, *sht_win, *sht_win_b[3];    /* ウィンドウを4つ用意 */
    struct TASK *task_a, *task_b[3];    /* タスクBは4つ */
    struct TIMER *timer;
    ...
    sheet_updown(sht_win,       4); /* ウィンドウの下敷きの高さを指定 */
    sheet_updown(sht_mouse,     5); /* マウスの下敷きの高さを指定 */
